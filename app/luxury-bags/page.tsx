  ...
  return (
    <>
      <section className="relative h-[50vh] min-h-[380px] w-full">
        <SafeImage src={heroImage || "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=1600&q=85&auto=format&fit=crop"} alt="Luxury bags" fill className="object-cover" priority sizes="100vw" />
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-12 lg:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative aspect-[4/5] overflow-hidden">
              <SafeImage src={storyImage || "https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=900&q=85&auto=format&fit=crop"} alt="Bag craftsmanship" fill className="object-cover" sizes="(max-width:1024px)100vw,50vw" />
