  ...
  return (
    <>
      <section className="relative h-[50vh] min-h-[380px] w-full">
        <Image src="https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?w=1600&q=85&auto=format&fit=crop" alt="Luxury perfumes" fill className="object-cover" priority sizes="100vw" />
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-12 lg:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative aspect-[4/5] overflow-hidden">
              <Image src="https://images.unsplash.com/photo-1563170351-be82bc888aa4?w=900&q=85&auto=format&fit=crop" alt="Perfume craftsmanship" fill className="object-cover" sizes="(max-width:1024px) 100vw,50vw" />
